/*	$FreeBSD: stable/12/sys/dev/usb/wlan/if_ural.c 343975 2019-02-10 20:59:35Z avos $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: stable/12/sys/dev/usb/wlan/if_ural.c 343975 2019-02-10 20:59:35Z avos $");
