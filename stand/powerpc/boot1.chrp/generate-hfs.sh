...
# $FreeBSD: stable/12/stand/powerpc/boot1.chrp/generate-hfs.sh 305894 2016-09-16 22:51:37Z jhibbits $
...
echo '# $FreeBSD: stable/12/stand/powerpc/boot1.chrp/generate-hfs.sh 305894 2016-09-16 22:51:37Z jhibbits $' >> Makefile.hfs
...
echo '$FreeBSD: stable/12/stand/powerpc/boot1.chrp/generate-hfs.sh 305894 2016-09-16 22:51:37Z jhibbits $' >> $OUTPUT_FILE.bz2.uu
